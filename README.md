...
For your convenience, we also provide an example app that can be used as a basis for your own implementation. If you are fine with the look-and-feel of the example app, you do not need to make any changes at all. The example app can be found [here](https://github.com/online-payments/sdk-client-swift-example).
